(function ($) {
    ...
    function lebagolCustomSelect(parent, select) {
    ...
    $(document).ready(function () {
        lebagolCustomSelect('woocommerce-ordering', '.woocommerce-ordering .orderby');
        lebagolCustomSelect('lebagol-products-per-page', '.lebagol-products-per-page .per_page');
    });
