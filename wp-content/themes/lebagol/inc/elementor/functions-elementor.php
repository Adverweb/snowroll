...
if ( ! function_exists( 'lebagol_elementor_parse_text_editor' ) ) {
	function lebagol_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'lebagol_elementor_get_strftime' ) ) {
	function lebagol_elementor_get_strftime( $instance, $obj ) {
		$string = '';
