(function ($, elementor,elementorCommon) {
        ...
        ControlSelect2ProductsReview = elementor.modules.controls.Select2.extend({
            cache: null,
                ...
                return jQuery.extend(elementor.modules.controls.Select2.prototype.getSelect2DefaultOptions.apply(this, arguments), {
                    ajax: {
                        transport: function transport(params, success, failure) {
                            ...
                            var data = {},
                                action = 'panel_posts_control_filter_product_review';
            ...
            getValueTitles: function getValueTitles() {
                ...
                var ids = this.getControlValue(),
                    action = 'query_control_value_product_review';
        ...
        elementor.addControlView('products_review', ControlSelect2ProductsReview);
