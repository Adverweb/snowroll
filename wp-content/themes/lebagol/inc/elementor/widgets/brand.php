 ...
 * @since 1.0.0
 */
class Lebagol_Elementor_Brand extends Lebagol_Base_Widgets_Swiper {
    ...
    public function get_title() {
        return esc_html__('Brands', 'lebagol');
    }
    ...
    public function get_script_depends() {
        return ['lebagol-elementor-brand', 'lebagol-elementor-swiper'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'lebagol'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'lebagol'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'lebagol'),
                'placeholder' => esc_html__('Brand Name', 'lebagol'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'brand_source',
            [
                'label'   => esc_html__('Brand Source', 'lebagol'),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__('Image', 'lebagol'),
                    'icon'  => esc_html__('Icon', 'lebagol')
                ],
            ]
        );
        ...
        $repeater->add_control(
            'image_overlay',
            [
                'label'   => esc_html__('Image Background', 'lebagol'),
                'type'    => Controls_Manager::MEDIA,
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Brand Item', 'lebagol'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .grid-item:hover .elementor-brand-item' => 'border-color: {{VALUE}};',
                ],
            ]
        );
...
$widgets_manager->register(new Lebagol_Elementor_Brand());
