 ...
 * @since 1.0.0
 */
class Lebagol_Widget_Button extends Widget_Base
{
    ...
    {
        return esc_html__('Lebagol Button', 'lebagol');
    }
    ...
    protected function register_controls()
    {
        ...
        $default_args = [
            'section_condition' => [],
            'button_default_text' => esc_html__('Click here', 'lebagol'),
            'text_control_label' => esc_html__('Text', 'lebagol'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'outline' => esc_html__('Outline', 'lebagol'),
                    'info' => esc_html__('Info', 'lebagol'),
                    'success' => esc_html__('Success', 'lebagol'),
                    'warning' => esc_html__('Warning', 'lebagol'),
                    'danger' => esc_html__('Danger', 'lebagol'),
                    'link' => esc_html__( 'Link', 'lebagol' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => esc_html__('Justified', 'lebagol'),
        ...
        $this->add_control(
            'icon_indent',
            [
                'label' => esc_html__('Icon Spacing', 'lebagol'),
        ...
        $this->add_control(
            'button_css_id',
            [
                'label' => esc_html__('Button ID', 'lebagol'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => '',
                'title' => esc_html__('Add your custom id WITHOUT the Pound key. e.g: my-id', 'lebagol'),
                /* translators: %1$s Code open tag, %2$s: Code close tag. */
                'description' => esc_html__('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'lebagol'),
                'separator' => 'before',
                'condition' => $args['section_condition'],
            ]
        );
...
$widgets_manager->register(new Lebagol_Widget_Button());
