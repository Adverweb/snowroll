...
class Lebagol_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'lebagol-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Lebagol Vertical Menu', 'lebagol');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'link',
            [
                'label' => esc_html__( 'Title Link', 'lebagol' ),
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'lebagol'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Layout 1', 'lebagol'),
                    'style-2' => esc_html__('Layout 2', 'lebagol'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .lebagol-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'lebagol'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .lebagol-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'lebagol'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'lebagol'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute( 'link', 'class', 'vertical-navigation-title' );

        ?>
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'lebagol'); ?>">
...
$widgets_manager->register(new Lebagol_Elementor_Vertiacl_Menu());
