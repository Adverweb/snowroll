<?php
/**
 * Lebagol_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Lebagol_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Lebagol_Product_Brand_List_Walker', false)) :

	class Lebagol_Product_Brand_List_Walker extends Walker {
