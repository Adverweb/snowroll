<?php
/**
 * Lebagol WooCommerce Adjacent Products Class
 *
 * @package  lebagol
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Lebagol_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Lebagol WooCommerce Adjacent Products Class
	 */
	class Lebagol_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'lebagol_woocommerce_adjacent_query_args', $args ) );
