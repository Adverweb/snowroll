...
do_action('lebagol_loop_before');

$columns     = lebagol_get_theme_option('blog_columns');
$blog_style  = lebagol_get_theme_option('blog_style');
...
/**
 * Functions hooked in to lebagol_loop_after action
 *
 * @see lebagol_paging_nav - 10
 */
do_action('lebagol_loop_after');
